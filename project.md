...
- **Phase 3 — Realtime calling** — ✅ **voice (Sprint 3.1) + video (Sprint 3.2)** over WebRTC, both header buttons live; remaining: **screen share (3.3)**, group calls (Phase 6), optional **TURN/coturn** for strict-NAT/mobile reliability.
