...
**Last updated:** June 23, 2026 (Sprint C.1 — custom status + expiry, friend bio in About, chat-header ⋮ menu + custom status, avatar lightbox, responsive mobile notifications, onboarding "use a different account", Friends→Message focuses Chats)  
